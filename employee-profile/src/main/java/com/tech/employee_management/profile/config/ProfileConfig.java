...
public class ProfileConfig {
    ...
    @Bean
    public ProfileApi profileApi(EmployeeRepository employeeRepository, DepartmentRepository departmentRepository, AsyncGateway<ProfileEvent> profileEventPublisher){
        return new ProfileApiImpl(employeeRepository, departmentRepository, profileEventPublisher);
    }
